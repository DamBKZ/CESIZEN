...
exports.getAngularJsonValue = exports.createTemplate = exports.getDirectoriesAndCreateSpecs = exports.getLatestNodeVersion = exports.getAngularSemverVersion = void 0;
...
function getAngularSemverVersion(tree) {
    ...
    try {
        if (packageNode !== null) {
            const version = packageNode && packageNode.version ?
                (0, semver_1.minVersion)(packageNode.version) : null;
            return version;
        }
        return null;
    }
...
exports.getAngularSemverVersion = getAngularSemverVersion;
/**
